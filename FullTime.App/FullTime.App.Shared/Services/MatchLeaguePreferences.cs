...
public class MatchLeaguePreferences(IMatchLeaguePreferenceStore store)
{
    ...
    // (A same-day API-Football/the-odds-api cutover briefly re-keyed this to API-Football's IDs
    // and back again — see HANDOVER.md — but that window was short enough, and no real build ever
    // shipped with it, that no translation layer for it was needed here.)
